...
@synthesize myArdoiseViewController;

- (void)dealloc
{
    [myArdoiseViewController release];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ArdoiseViewController *tmpViewController;
    // Override point for customization after application launch.
    if (UI_USER_INTERFACE_IDIOM() != UIUserInterfaceIdiomPad) 
    {
        tmpViewController = [[ArdoiseViewController alloc] initWithNibName:@"ArdoiseViewController-others" bundle:nil];
    } 
    else
    {
        tmpViewController = [[ArdoiseViewController alloc] initWithNibName:@"ArdoiseViewController" bundle:nil];
    }
    self.myArdoiseViewController = tmpViewController;
    [tmpViewController release];

    [self.window setRootViewController:self.myArdoiseViewController];
